...
class $HabitEntriesTable extends HabitEntries
  ...
  @override
  List<GeneratedColumn> get $columns => [habitId, plantedOn, intensity];
  @override
  String get aliasedName => _alias ?? actualTableName;
  @override
  String get actualTableName => $name;
  ...
  @override
  Set<GeneratedColumn> get $primaryKey => {habitId, plantedOn};
  @override
...
class HabitEntry extends DataClass implements Insertable<HabitEntry> {
  ...
  HabitEntry copyWith({String? habitId, DateTime? plantedOn, int? intensity}) =>
      HabitEntry(
  ...
  @override
  int get hashCode => Object.hash(habitId, plantedOn, intensity);
  @override
  bool operator ==(Object other) =>
      identical(this, other) ||
      (other is HabitEntry &&
